...
if($results)
{
 echo "<center><div class='alert alert-success'><center><h4>Your Order has cancelled successfully</h4></center></div></center>";
...
{
	echo "<center><div class='alert alert-danger'><center><h4>Your Order has not cancelled</h4></center></div></center>";
	       ?>
            <script type="text/javascript">
              setTimeout(function(){window.location.href='index.php'},1000);
            </script>
