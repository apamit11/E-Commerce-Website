...
<?php
		 ...
		 else
		 {
		  if(isset($_POST["submit2"]))
		  {
			  ...
			  if(preg_match('/^\d{10}$/',$contact))
						    ...
						    if($i==1)
						    {
				  $query1="INSERT INTO user_orders (id,name,stream,sem,contact,address,qty,amount,username,order_date,delivery) VALUE('','$name','$_SESSION[stream]','$_SESSION[sem]','$contact','$add','$_SESSION[qty]','$_SESSION[price1]','$_SESSION[username]','$date','$b')";
		...
		<form method="post" action="">
		 ...
		 <tr>
		 <td>
		 <b>Stream</b><input type="text" style="height:35px;" name="stream" class="form-control" value="<?php echo $_SESSION['stream']; ?>" disabled>
		 </td>
		 </tr>
		 <tr>
		 <td>
		 <b>Semester</b><input type="text" style="height:35px;" name="sem" class="form-control" value="<?php echo $_SESSION['sem']; ?>" disabled>
		 </td>
		 </tr>
		 <tr>
		 <td>
		 ...
		 <td>
		 	<b>Total Price</b>
		 <input type="text" style="height:35px;" name="amount" value="<?php echo $_SESSION['price1']; ?>" class="form-control" disabled>
		 </td>
		 </tr>
		 <tr>
		 <td>
