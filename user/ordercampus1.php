...
<?php
		 ...
		 else
		 {
		  if(isset($_POST["submit2"]))
		  {
			  ...
			  if(preg_match('/^\d{10}$/',$contact))
						    ...
						    if($i==1)
						    {
				  $query1="INSERT INTO user_orders (id,name,stream,sem,contact,address,qty,amount,username,order_date,delivery) VALUE('','$name','$_SESSION[stream1]','$_SESSION[sem1]','$contact','$add','$_SESSION[qty2]','$_SESSION[sel_price22]','$_SESSION[username]','$date','$b')";
				  ...
				  else
				  {
					  ...
					  ?>
						<script type="text/javascript">
							setTimeout(function(){window.location.href='single1.php'},1000);
						</script>
					<?php
				  }
				}
		...
		<form method="post" action="ordercampus1.php">
		 <tr>
		 <td>
		 <b>Name</b><input type="text" style="height:35px;" name="name" placeholder="Name" class="form-control" required="">
		 </td>
		 </tr>
		 <tr>
		 <td>
		 <b>Stream</b><input type="text" style="height:35px;" name="stream" class="form-control" value="<?php echo $_SESSION['stream1']; ?>" disabled>
		 </td>
		 </tr>
		 <tr>
		 <td>
		 <b>Semester</b><input type="text" style="height:35px;" name="sem" class="form-control" value="<?php echo $_SESSION['sem1']; ?>" disabled>
		 </td>
		 </tr>
		 <tr>
		 <td>
		 <b>Contact Number</b><input type="text" style="height:35px;" name="contact" placeholder="Contact Number" class="form-control" required="">
		 </td>
		 </tr>
		 <tr>
		 <td>
		 	<b>College Name</b>
		 <select style="height:35px;" name="col" class="form-control">
		 <?php
		 $query="select * from colleges";
		 $result=mysqli_query($conn,$query);
		 while($var=mysqli_fetch_assoc($result))
		 {
			 $college=$var["colleges"];
			 ?>
		 ...
		 <td>
		 <b>Quantity</b>
		 <input type="text" style="height:35px;" name="qty" value="<?php echo $_SESSION['qty2']; ?>" class="form-control" disabled>
		 </td>
		 </tr>
		 <tr>
		 <td>
		 	<b>Total Price</b>
		 <input type="text" style="height:35px;" name="amount" value="<?php echo $_SESSION["sel_price22"]; ?>" class="form-control" disabled>
		 </td>
		 </tr>
		 <tr>
		 <td>
		 ...
		 <tr><td colspan="2">
		 <center><input type="submit" name="submit2" class="btn btn-primary" value="Place order"></center>
		 </td></tr></form>
		</table>
<?php  } ?>
	</div>
