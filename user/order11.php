...
<?php
		 ...
		 else
		 {
		  if(isset($_POST["submit1"]))
		  {
			  ...
			  $b="Within 4 Days";
				  $query1="INSERT INTO user_orders (id,name,stream,sem,contact,address,qty,amount,username,delivery) VALUE('','$name','$_SESSION[stream1]','$_SESSION[sem1]','$contact','$add','$_SESSION[qty2]','$_SESSION[price22]','$_SESSION[username]','$b')";
		...
		<form method="post" action="order11.php">
		 <tr>
		 <td>
		 	<b>Name</b>
		 <input type="text" style="height:35px;" name="name" placeholder="Name" class="form-control" required="">
		 </td>
		 </tr>
		 <tr>
		 <td>
		 	<b>Stream</b>
		 <input type="text" style="height:35px;" name="stream" class="form-control" value="<?php echo $_SESSION['stream1']; ?>" disabled>
		 </td>
		 </tr>
		 <tr>
		 <td>
		 	<b>Semester</b>
		 <input type="text" style="height:35px;" name="sem" class="form-control" value="<?php echo $_SESSION['sem1']; ?>" disabled>
		 </td>
		 </tr>
		 <tr>
		 <td>
		 	<b>Contact Number</b>
		 <input type="text" style="height:35px;" name="contact" placeholder="Contact Number" class="form-control" required="">
		 </td>
		 </tr>
		 <tr>
		 <td>
		 	<b>Address</b>
		 <textarea class="form-control" rows="3" placeholder="Address" name="add" required=""></textarea>
		 </td></tr>
		 <tr>
		 <td>
		 	<b>Quantity</b>
		 ...
		 <td>
		 	<b>Total Price</b>
		 <input type="text" style="height:35px;" name="amount" value="<?php echo $_SESSION["price22"]; ?>" class="form-control" disabled>
		 </td>
		 </tr>
		 <tr>
		 <td>
